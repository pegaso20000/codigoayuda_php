<?php
	...
	$id = $_GET['id'];  //se crea la variable del id


	// consulta para traer los datos mediante el id

	$sql = "SELECT * FROM personas WHERE id = '$id'";
	$resultado = $mysqli->query($sql);
	$row = $resultado->fetch_array(MYSQLI_ASSOC); //codigo para traer los resultados
...
<html lang="es">
	...
	<body>
		<div class="container">
			...
			<!-- formulario de modificar con el simple hecho de que se busca los datos -->
